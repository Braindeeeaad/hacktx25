/**
 * Simple Cloudflare D1 Test
 * Tests Cloudflare D1 connection with direct environment variable setting
 */
...
async function testCloudflareSimple() {
  console.log('🚀 SIMPLE CLOUDFLARE D1 TEST');
  console.log('==============================');
  console.log('🎯 Testing Cloudflare D1 connection with direct environment variables');
